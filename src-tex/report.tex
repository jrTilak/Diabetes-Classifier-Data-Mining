% Springer Nature author template, version 3.1 (December 2024).
% Replace the author/course details below with the final institutional details
% and review the full text in your own words before submission.
...
\subsection{Custom $k$-nearest neighbours}\label{subsec:knn}
...
The original investigators who collected and documented the dataset are acknowledged through the citation to Smith et al. \cite{smith1988adap}.
...
The named author is responsible for running and checking the experiment, interpreting the findings, revising the manuscript in their own words, and approving the submitted version.

\bmhead{AI-assisted drafting}

A generative AI assistant was used to help organize the initial LaTeX draft, prepare reproducible plotting code, and check consistency between the code and report. It was not used as a source of scientific evidence. All claims, citations, wording, and calculations must be reviewed and accepted by the author before submission.
